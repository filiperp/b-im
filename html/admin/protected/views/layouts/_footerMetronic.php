...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/metronic/assets/global/plugins/excanvas.min.js"></script>
<![endif]-->
...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/metronic/assets/global/plugins/bootbox/bootbox.min.js" type="text/javascript"></script>
...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/metronic/band/js/MetronicMenu.js" type="text/javascript"></script>
...
$footerClientScript->registerScript('startFooterMetronicScript', "MetronicMenu.init();", CClientScript::POS_READY);
