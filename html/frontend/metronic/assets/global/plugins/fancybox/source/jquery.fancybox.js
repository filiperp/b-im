	...
	$.extend(F, {
		...
		defaults: {
			...
			tpl: {
				...
				next     : '',
				nextOLD     : '<a title="Next" class="fancybox-nav fancybox-next" href="javascript:;"><span></span></a>',
				prev     : '',
				prevOLD     : '<a title="Previous" class="fancybox-nav fancybox-prev" href="javascript:;"><span></span></a>'
			},
