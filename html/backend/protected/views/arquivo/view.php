...
array(
			...
			'type' => 'raw',
			'value' => $model->programaIdPrograma !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->programaIdPrograma)), array('programa/view', 'id' => GxActiveRecord::extractPkValue($model->programaIdPrograma, true))) : null,
			),
	),
)); ?>
