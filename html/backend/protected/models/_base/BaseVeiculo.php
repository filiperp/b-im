...
abstract class BaseVeiculo extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('ref_veiculo, nome_veiculo, descricao_veiculo, imagem_veiculo', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id_veiculo, ref_veiculo, nome_veiculo, descricao_veiculo, imagem_veiculo', 'safe', 'on'=>'search'),
		);
	}

	public function relations() {
		return array(
			'analises' => array(self::HAS_MANY, 'Analise', 'veiculo_id_veiculo'),
			'pracas' => array(self::HAS_MANY, 'Praca', 'veiculo_id_veiculo'),
		);
	}
